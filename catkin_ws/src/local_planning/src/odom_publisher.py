...
start_pub = rospy.Publisher('/odom', Odometry, queue_size=10)
start = Odometry()
...
start.pose.covariance = [0]*36


start.twist.twist.linear.x = 0
start.twist.twist.linear.y = 0
start.twist.twist.linear.z = 0
start.twist.twist.angular.x = 0
start.twist.twist.angular.y = 0
start.twist.twist.angular.z = 0
start.twist.covariance = [0]*36
